...
wget -P /home https://raw.githubusercontent.com/Mcassador/SSH-WEB/main/verpweb > /dev/null 2>&1
[[ -f "/home/verpweb" ]] && {
...
wget -P /home https://raw.githubusercontent.com/Mcassador/SSH-WEB/main/verweb > /dev/null 2>&1
[[ -f "/home/verweb" ]] && {
