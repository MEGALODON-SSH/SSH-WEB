    ...
    <div class="card card border-primary">
      <div class="card-body p-b-0">
        ...
        <ul class="nav nav-tabs customtab" role="tablist">
          <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#senha" role="tab" aria-selected="true"><i data-feather="key"></i>Senha</span></a> </li>
		  ...
		  <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#hist" role="tab" aria-selected="false"><i data-feather="bar-chart-2"></i>Histórico</span></a> </li>
            ...
            <div>
              <div class="box-header with-border">
                <form role="form2" action="../pages/system/funcoes.conta.ssh.php" method="post" class="form-horizontal">
                  ...
                  <div class="text-center">
                    <br><button type="submit" class="btn btn-primary">Alterar limite simultâneo</button><br>
                  </div>
                </form>
              </div>
            </div>
