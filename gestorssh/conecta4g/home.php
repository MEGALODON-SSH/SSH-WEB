...
<div class="container">
    <center>
        <a href="/conecta4g/home.php"><img class="mt-5" src="<?= getConfig('logo') ?>" width="<?= getConfig('largura') ?>" height="<?= getConfig('altura') ?>"></a><br>
            ...
            <div class="card border-0 shadow">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom py-3">
                        <div>
                            <div class="h6 mb-0 d-flex align-items-center">
                                <a href="/conecta4g/app.php"><i class="fa-solid fa-gear"></i> Configurações do app</a>
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom py-3">
                        <div>
                            <div class="h6 mb-0 d-flex align-items-center">
                                <a href="/conecta4g/perfil.php"><i class="fa-solid fa-user"></i> Configurações de perfil</a>
                            </div>
                        </div>
                    </div>
                    <?php
                    if (getAdm($uid) == true) : ?>
                        <div class="d-flex align-items-center justify-content-between border-bottom py-3">
                            <div>
                                <div class="h6 mb-0 d-flex align-items-center">
                                    <a href="/conecta4g/usuarios.php"><i class="fa-solid fa-users"></i> Gerenciar usuários </a>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
