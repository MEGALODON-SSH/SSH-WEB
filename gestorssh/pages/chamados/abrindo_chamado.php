...
if (isset($_POST['tipo'])) {
	...
	if ($usuario['id_mestre'] <> 0) {
		//Sucesso
		$criachamado = "insert into chamados (usuario_id,tipo,status,motivo,mensagem,data,id_mestre,login) values ('" . $usuarioid . "','" . $probl . "','aberto','" . $motivo . "','" . $msgprobl . "','" . date('Y-m-d H:i:s') . "','" . $usuario['id_mestre'] . "','" . $usuario['nome'] . "')";
		...
		//Sucesso
		$criachamado = "insert into chamados (usuario_id,tipo,status,motivo,mensagem,data,login) values ('" . $usuarioid . "','" . $probl . "','aberto','" . $motivo . "','" . $msgprobl . "','" . date('Y-m-d H:i:s') . "','" . $usuario['nome'] . "')";
		$criachamado = $conn->prepare($criachamado);
		$criachamado->execute();
